...
#s(hash-table test equal data ("straight" ("2026-03-06 19:03:17" ("emacs") (:type git :host github :repo "radian-software/straight.el" :files ("straight*.el") :branch "main" :package "straight" :local-repo "straight.el")) "org-elpa" ("2026-03-06 19:03:17" nil (:local-repo nil :package "org-elpa" :type git)) "melpa" ("2026-03-06 19:03:25" nil (:type git :host github :repo "melpa/melpa" :build nil :package "melpa" :local-repo "melpa")) "gnu-elpa-mirror" ("2026-03-06 19:03:25" nil (:type git :host github :repo "emacs-straight/gnu-elpa-mirror" :build nil :package "gnu-elpa-mirror" :local-repo "gnu-elpa-mirror")) "use-package" ("2026-03-06 19:03:28" ("emacs" "bind-key") (:type git :host github :repo "emacs-straight/use-package" :files ("*" (:exclude ".git")) :package "use-package" :local-repo "use-package")) "bind-key" ("2026-03-06 19:03:27" ("emacs") (:type git :host github :repo "emacs-straight/bind-key" :files ("*" (:exclude ".git")) :package "bind-key" :local-repo "bind-key")) "no-littering" ("2026-03-06 19:03:31" ("emacs" "compat") (:type git :host github :repo "emacscollective/no-littering" :package "no-littering" :local-repo "no-littering")) "compat" ("2026-03-06 19:03:31" ("emacs" "seq") (:type git :host github :repo "emacs-straight/compat" :files ("*" (:exclude ".git")) :package "compat" :local-repo "compat")) "seq" ("2026-03-06 19:03:31" nil (:type git :host github :repo "emacs-straight/seq" :files ("*" (:exclude ".git")) :package "seq" :local-repo "seq")) "vterm" ("2026-03-06 19:03:32" ("emacs") (:type git :files ("CMakeLists.txt" "elisp.c" "elisp.h" "emacs-module.h" "etc" "utf8.c" "utf8.h" "vterm.el" "vterm-module.c" "vterm-module.h" "vterm-pkg.el") :host github :repo "akermu/emacs-libvterm" :package "vterm" :local-repo "emacs-libvterm")) "elfeed" ("2026-03-06 19:03:43" ("emacs") (:type git :files (:defaults "README.md" "elfeed-pkg.el") :host github :repo "skeeto/elfeed" :package "elfeed" :local-repo "elfeed")) "rainbow-delimiters" ("2026-03-06 19:03:44" nil (:type git :host github :repo "Fanael/rainbow-delimiters" :package "rainbow-delimiters" :local-repo "rainbow-delimiters")) "smartparens" ("2026-03-06 19:03:52" ("dash") (:type git :host github :repo "Fuco1/smartparens" :package "smartparens" :local-repo "smartparens")) "dash" ("2026-03-06 19:03:52" ("emacs") (:type git :files ("dash.el" "dash.texi" "dash-pkg.el") :host github :repo "magnars/dash.el" :package "dash" :local-repo "dash.el")) "yasnippet" ("2026-03-06 19:03:59" ("cl-lib" "emacs") (:type git :files ("yasnippet.el" "snippets" "yasnippet-pkg.el") :host github :repo "joaotavora/yasnippet" :package "yasnippet" :local-repo "yasnippet")) "nongnu-elpa" ("2026-03-06 19:03:55" nil (:type git :repo "https://github.com/emacsmirror/nongnu_elpa.git" :depth (full single-branch) :local-repo "nongnu-elpa" :build nil :package "nongnu-elpa")) "el-get" ("2026-03-06 19:03:58" nil (:type git :host github :repo "dimitri/el-get" :build nil :package "el-get" :local-repo "el-get")) "emacsmirror-mirror" ("2026-03-06 19:03:59" nil (:type git :host github :repo "emacs-straight/emacsmirror-mirror" :build nil :package "emacsmirror-mirror" :local-repo "emacsmirror-mirror")) "journalctl-mode" ("2026-03-06 19:04:02" ("emacs") (:type git :host github :repo "SebastianMeisel/journalctl-mode" :package "journalctl-mode" :local-repo "journalctl-mode")) "general" ("2026-03-06 19:04:04" ("emacs" "cl-lib") (:type git :host github :repo "noctuid/general.el" :package "general" :local-repo "general.el")) "treemacs" ("2026-03-06 19:04:18" ("emacs" "cl-lib" "dash" "s" "ace-window" "pfuture" "hydra" "ht" "cfrs") (:type git :files (:defaults "Changelog.org" "icons" "src/elisp/treemacs*.el" "src/scripts/treemacs*.py" (:exclude "src/extra/*") "treemacs-pkg.el") :host github :repo "Alexander-Miller/treemacs" :package "treemacs" :local-repo "treemacs")) "s" ("2026-03-06 19:04:08" nil (:type git :host github :repo "magnars/s.el" :package "s" :local-repo "s.el")) "ace-window" ("2026-03-06 19:04:11" ("avy") (:type git :host github :repo "abo-abo/ace-window" :package "ace-window" :local-repo "ace-window")) "avy" ("2026-03-06 19:04:10" ("emacs" "cl-lib") (:type git :host github :repo "abo-abo/avy" :package "avy" :local-repo "avy")) "pfuture" ("2026-03-06 19:04:12" ("emacs") (:type git :host github :repo "Alexander-Miller/pfuture" :package "pfuture" :local-repo "pfuture")) "hydra" ("2026-03-06 19:04:13" ("cl-lib" "lv") (:type git :files (:defaults (:exclude "lv.el") "hydra-pkg.el") :host github :repo "abo-abo/hydra" :package "hydra" :local-repo "hydra")) "lv" ("2026-03-06 19:04:12" nil (:files ("lv.el" "lv-pkg.el") :package "lv" :local-repo "hydra" :type git :repo "abo-abo/hydra" :host github)) "ht" ("2026-03-06 19:04:13" ("dash") (:type git :host github :repo "Wilfred/ht.el" :package "ht" :local-repo "ht.el")) "cfrs" ("2026-03-06 19:04:16" ("emacs" "dash" "s" "posframe") (:type git :host github :repo "Alexander-Miller/cfrs" :package "cfrs" :local-repo "cfrs")) "posframe" ("2026-03-06 19:04:16" ("emacs") (:type git :host github :repo "tumashu/posframe" :package "posframe" :local-repo "posframe")) "nerd-icons" ("2026-03-06 19:04:23" ("emacs") (:type git :files (:defaults "data" "nerd-icons-pkg.el") :host github :repo "rainstormstudio/nerd-icons.el" :package "nerd-icons" :local-repo "nerd-icons.el")) "treemacs-nerd-icons" ("2026-03-06 19:04:24" ("emacs" "nerd-icons" "treemacs") (:type git :host github :repo "rainstormstudio/treemacs-nerd-icons" :package "treemacs-nerd-icons" :local-repo "treemacs-nerd-icons")) "nerd-icons-completion" ("2026-03-06 19:04:24" ("emacs" "nerd-icons" "compat") (:type git :host github :repo "rainstormstudio/nerd-icons-completion" :package "nerd-icons-completion" :local-repo "nerd-icons-completion")) "doom-themes" ("2026-03-06 19:04:31" ("emacs" "cl-lib") (:type git :files (:defaults "themes/*.el" "themes/*/*.el" "extensions/*.el" "doom-themes-pkg.el") :host github :repo "doomemacs/themes" :package "doom-themes" :local-repo "themes")) "doom-modeline" ("2026-03-06 19:04:36" ("emacs" "compat" "nerd-icons" "shrink-path") (:type git :host github :repo "seagle0128/doom-modeline" :package "doom-modeline" :local-repo "doom-modeline")) "shrink-path" ("2026-03-06 19:04:35" ("emacs" "s" "dash" "f") (:type git :host gitlab :repo "bennya/shrink-path.el" :package "shrink-path" :local-repo "shrink-path.el")) "f" ("2026-03-06 19:04:35" ("emacs" "s" "dash") (:type git :host github :repo "rejeep/f.el" :package "f" :local-repo "f.el")) "which-key" ("2026-03-06 19:04:37" ("emacs") (:type git :host github :repo "justbur/emacs-which-key" :package "which-key" :local-repo "emacs-which-key")) "ace-jump-mode" ("2026-03-06 19:04:38" nil (:type git :host github :repo "winterTTr/ace-jump-mode" :package "ace-jump-mode" :local-repo "ace-jump-mode")) "fzf" ("2026-03-06 19:04:39" ("emacs") (:type git :host github :repo "bling/fzf.el" :package "fzf" :local-repo "fzf.el")) "vertico" ("2026-03-06 19:04:41" ("emacs" "compat") (:type git :files (:defaults "extensions/vertico-*.el" "vertico-pkg.el") :host github :repo "minad/vertico" :package "vertico" :local-repo "vertico")) "orderless" ("2026-03-06 19:04:42" ("emacs" "compat") (:type git :host github :repo "oantolin/orderless" :package "orderless" :local-repo "orderless")) "marginalia" ("2026-03-06 19:04:43" ("emacs" "compat") (:type git :host github :repo "minad/marginalia" :package "marginalia" :local-repo "marginalia")) "corfu" ("2026-03-06 19:04:45" ("emacs" "compat") (:files (:defaults "extensions/") :includes (corfu-info corfu-history) :repo "minad/corfu" :host github :package "corfu" :type git :local-repo "corfu")) "nerd-icons-corfu" ("2026-03-06 19:04:46" ("emacs" "nerd-icons") (:type git :host github :repo "LuigiPiucco/nerd-icons-corfu" :package "nerd-icons-corfu" :local-repo "nerd-icons-corfu")) "corfu-terminal" ("2026-03-06 19:04:50" ("emacs" "corfu" "popon") (:repo "https://codeberg.org/akib/emacs-corfu-terminal" :package "corfu-terminal" :type git :local-repo "corfu-terminal")) "popon" ("2026-03-06 19:04:50" ("emacs") (:repo "https://codeberg.org/akib/emacs-popon" :package "popon" :type git :local-repo "popon")) "consult" ("2026-03-06 19:04:54" ("emacs" "compat") (:type git :host github :repo "minad/consult" :package "consult" :local-repo "consult")) "consult-lsp" ("2026-03-06 19:06:14" ("emacs" "lsp-mode" "consult" "f") (:type git :host github :repo "gagbo/consult-lsp" :package "consult-lsp" :local-repo "consult-lsp")) "lsp-mode" ("2026-03-06 19:06:13" ("emacs" "dash" "f" "ht" "spinner" "markdown-mode" "lv" "eldoc") (:type git :files (:defaults "clients/*.*" "lsp-mode-pkg.el") :host github :repo "emacs-lsp/lsp-mode" :package "lsp-mode" :local-repo "lsp-mode")) "spinner" ("2026-03-06 19:06:06" ("emacs") (:type git :host github :repo "emacs-straight/spinner" :files ("*" (:exclude ".git")) :package "spinner" :local-repo "spinner")) "markdown-mode" ("2026-03-06 19:06:08" ("emacs") (:type git :host github :repo "jrblevin/markdown-mode" :package "markdown-mode" :local-repo "markdown-mode")) "eldoc" ("2026-03-06 19:06:09" ("emacs") (:type git :host github :repo "emacs-straight/eldoc" :files ("*" (:exclude ".git")) :package "eldoc" :local-repo "eldoc")) "embark" ("2026-03-06 19:06:16" ("emacs" "compat") (:type git :files ("embark.el" "embark-org.el" "embark.texi" "embark-pkg.el") :host github :repo "oantolin/embark" :package "embark" :local-repo "embark")) "embark-consult" ("2026-03-06 19:06:16" ("emacs" "compat" "embark" "consult") (:files ("embark-consult.el" "embark-consult-pkg.el") :package "embark-consult" :local-repo "embark" :type git :repo "oantolin/embark" :host github)) "lsp-ui" ("2026-03-06 19:06:20" ("emacs" "dash" "lsp-mode" "markdown-mode") (:type git :files (:defaults "lsp-ui-doc.html" "resources" "lsp-ui-pkg.el") :host github :repo "emacs-lsp/lsp-ui" :package "lsp-ui" :local-repo "lsp-ui")) "lsp-treemacs" ("2026-03-06 19:06:22" ("emacs" "dash" "f" "ht" "treemacs" "lsp-mode") (:type git :files (:defaults "icons" "lsp-treemacs-pkg.el") :host github :repo "emacs-lsp/lsp-treemacs" :package "lsp-treemacs" :local-repo "lsp-treemacs")) "dap-mode" ("2026-03-06 19:06:32" ("emacs" "dash" "lsp-mode" "bui" "f" "s" "lsp-treemacs" "posframe" "ht" "lsp-docker") (:type git :files (:defaults "icons" "dap-mode-pkg.el") :host github :repo "emacs-lsp/dap-mode" :package "dap-mode" :local-repo "dap-mode")) "bui" ("2026-03-06 19:06:27" ("emacs" "dash") (:type git :host github :repo "alezost/bui.el" :package "bui" :local-repo "bui.el")) "lsp-docker" ("2026-03-06 19:06:31" ("emacs" "dash" "lsp-mode" "f" "s" "yaml" "ht") (:type git :host github :repo "emacs-lsp/lsp-docker" :package "lsp-docker" :local-repo "lsp-docker")) "yaml" ("2026-03-06 19:06:31" ("emacs") (:type git :host github :repo "zkry/yaml.el" :package "yaml" :local-repo "yaml.el")) "magit" ("2026-03-06 19:06:50" ("emacs" "compat" "cond-let" "llama" "magit-section" "seq" "transient" "with-editor") (:type git :files ("lisp/magit*.el" "lisp/git-*.el" "docs/magit.texi" "docs/AUTHORS.md" "LICENSE" ".dir-locals.el" ("git-hooks" "git-hooks/*") (:exclude "lisp/magit-section.el") "magit-pkg.el") :host github :repo "magit/magit" :package "magit" :local-repo "magit")) "cond-let" ("2026-03-06 19:06:42" ("emacs") (:type git :host github :repo "tarsius/cond-let" :package "cond-let" :local-repo "cond-let")) "llama" ("2026-03-06 19:06:43" ("emacs" "compat") (:type git :files ("llama.el" ".dir-locals.el" "llama-pkg.el") :host github :repo "tarsius/llama" :package "llama" :local-repo "llama")) "magit-section" ("2026-03-06 19:06:44" ("emacs" "compat" "cond-let" "llama" "seq") (:files ("lisp/magit-section.el" "docs/magit-section.texi" "magit-section-pkg.el" "magit-section-pkg.el") :package "magit-section" :local-repo "magit" :type git :repo "magit/magit" :host github)) "transient" ("2026-03-06 19:06:46" ("emacs" "compat" "cond-let" "seq") (:type git :host github :repo "magit/transient" :package "transient" :local-repo "transient")) "with-editor" ("2026-03-06 19:06:47" ("emacs" "compat") (:type git :host github :repo "magit/with-editor" :package "with-editor" :local-repo "with-editor")) "magit-gh-pulls" ("2026-03-06 19:06:56" ("emacs" "gh" "magit" "pcache" "s") (:type git :host github :repo "sigma/magit-gh-pulls" :package "magit-gh-pulls" :local-repo "magit-gh-pulls")) "gh" ("2026-03-06 19:06:55" ("emacs" "pcache" "logito" "marshal" "cl-lib") (:type git :host github :repo "sigma/gh.el" :package "gh" :local-repo "gh.el")) "pcache" ("2026-03-06 19:06:54" ("emacs") (:type git :host github :repo "sigma/pcache" :package "pcache" :local-repo "pcache")) "logito" ("2026-03-06 19:06:54" ("emacs") (:type git :host github :repo "sigma/logito" :package "logito" :local-repo "logito")) "marshal" ("2026-03-06 19:06:55" ("emacs" "ht") (:type git :host github :repo "sigma/marshal.el" :package "marshal" :local-repo "marshal.el")) "forge" ("2026-03-06 19:07:05" ("emacs" "compat" "closql" "cond-let" "emacsql" "ghub" "llama" "magit" "markdown-mode" "seq" "transient" "yaml") (:type git :files ("lisp/*.el" "docs/*.texi" ".dir-locals.el" "forge-pkg.el") :host github :repo "magit/forge" :package "forge" :local-repo "forge")) "closql" ("2026-03-06 19:07:01" ("emacs" "compat" "cond-let" "emacsql") (:type git :host github :repo "magit/closql" :package "closql" :local-repo "closql")) "emacsql" ("2026-03-06 19:07:01" ("emacs") (:type git :files (:defaults "README.md" "sqlite" "emacsql-pkg.el") :host github :repo "magit/emacsql" :package "emacsql" :local-repo "emacsql")) "ghub" ("2026-03-06 19:07:03" ("emacs" "compat" "cond-let" "llama" "treepy") (:type git :files ("lisp/*.el" "docs/*.texi" ".dir-locals.el" "ghub-pkg.el") :host github :repo "magit/ghub" :package "ghub" :local-repo "ghub")) "treepy" ("2026-03-06 19:07:03" ("emacs") (:type git :host github :repo "volrath/treepy.el" :package "treepy" :local-repo "treepy.el")) "org-roam" ("2026-03-06 19:07:17" ("emacs" "compat" "org" "emacsql" "magit-section") (:type git :files (:defaults "extensions/*" "org-roam-pkg.el") :host github :repo "org-roam/org-roam" :package "org-roam" :local-repo "org-roam")) "org-roam-ui" ("2026-03-06 19:07:39" ("emacs" "org-roam" "simple-httpd" "websocket") (:host github :repo "org-roam/org-roam-ui" :branch "main" :files ("*.el" "out") :package "org-roam-ui" :type git :local-repo "org-roam-ui")) "simple-httpd" ("2026-03-06 19:07:38" ("cl-lib") (:type git :host github :repo "skeeto/emacs-web-server" :package "simple-httpd" :local-repo "emacs-web-server")) "websocket" ("2026-03-06 19:07:39" ("cl-lib") (:type git :host github :repo "ahyatt/emacs-websocket" :package "websocket" :local-repo "emacs-websocket"))))
...
(fn &rest ARGS)" nil t) (autoload 'straight-dependencies "straight" "Return a list of PACKAGE's dependencies, as strings.
...
(fn &rest ARGS)" nil t) (autoload 'describe-personal-keybindings "bind-key" "Display all the personal keybindings defined by `bind-key'." t) (register-definition-prefixes "bind-key" '("bind-key" "override-global-m")) (provide 'bind-key-autoloads)) "use-package" ((use-package use-package-lint use-package-delight use-package-diminish use-package-ensure-system-package use-package-core use-package-jump use-package-ensure use-package-pkg use-package-bind-key use-package-autoloads) (autoload 'use-package-autoload-keymap "use-package-bind-key" "Load PACKAGE and bind key sequence invoking this function to KEYMAP-SYMBOL.
...
(fn NAME &rest ARGS)" nil t) (register-definition-prefixes "use-package-core" '("use-package-")) (autoload 'use-package-normalize/:delight "use-package-delight" "Normalize arguments to delight.
...
you must turn of these features completely.") (register-definition-prefixes "no-littering" '("emacs-session-filename" "no-littering-")) (provide 'no-littering-autoloads)) "vterm" ((vterm-autoloads vterm) (autoload 'vterm-module-compile "vterm" "Compile vterm-module." t) (autoload 'vterm--bookmark-handler "vterm" "Handler to restore a vterm bookmark BMK.
...
(fn &optional ARG)" t) (register-definition-prefixes "vterm" '("vterm-")) (provide 'vterm-autoloads)) "elfeed" ((elfeed-search elfeed-csv elfeed-autoloads elfeed-link elfeed-db elfeed-log xml-query elfeed-curl elfeed-lib elfeed-show elfeed-pkg elfeed) (autoload 'elfeed-update "elfeed" "Update all the feeds in `elfeed-feeds'." t) (autoload 'elfeed "elfeed" "Enter elfeed." t) (autoload 'elfeed-load-opml "elfeed" "Load feeds from an OPML file into `elfeed-feeds'.
...
or call the function `global-dash-fontify-mode'.") (custom-autoload 'global-dash-fontify-mode "dash" nil) (autoload 'global-dash-fontify-mode "dash" "Toggle Dash-Fontify mode in many buffers.
...
This allows Dash symbols to be looked up with \\[info-lookup-symbol]." t) (register-definition-prefixes "dash" '("!cdr" "!cons" "--" "->" "-a" "-butlast" "-c" "-d" "-e" "-f" "-gr" "-i" "-juxt" "-keep" "-l" "-m" "-no" "-o" "-p" "-r" "-s" "-t" "-u" "-value-to-list" "-when-let" "-zip" "dash-")) (provide 'dash-autoloads)) "smartparens" ((smartparens-org smartparens-ruby smartparens-rust smartparens-autoloads smartparens-text smartparens-go smartparens-latex smartparens-markdown sp-sublimetext-like smartparens-coq smartparens-python smartparens-ess smartparens-ml smartparens-pkg smartparens-clojure smartparens-racket smartparens-scala smartparens-rst smartparens-html smartparens-lua smartparens-config smartparens-crystal smartparens-elixir smartparens-swift smartparens-c smartparens-javascript smartparens-erlang smartparens smartparens-haskell smartparens-unison) (autoload 'sp-cheat-sheet "smartparens" "Generate a cheat sheet of all the smartparens interactive functions.
...
Setting this variable directly does not take effect;
either customize it (see the info node `Easy Customization')
or call the function `smartparens-global-strict-mode'.") (custom-autoload 'smartparens-global-strict-mode "smartparens" nil) (autoload 'smartparens-global-strict-mode "smartparens" "Toggle Smartparens-Strict mode in many buffers.
Specifically, Smartparens-Strict mode is enabled in all buffers where
...
Setting this variable directly does not take effect;
either customize it (see the info node `Easy Customization')
or call the function `smartparens-global-mode'.") (custom-autoload 'smartparens-global-mode "smartparens" nil) (autoload 'smartparens-global-mode "smartparens" "Toggle Smartparens mode in many buffers.
Specifically, Smartparens mode is enabled in all buffers where
...
Setting this variable directly does not take effect;
either customize it (see the info node `Easy Customization')
or call the function `show-smartparens-global-mode'.") (custom-autoload 'show-smartparens-global-mode "smartparens" nil) (autoload 'show-smartparens-global-mode "smartparens" "Toggle Show-Smartparens mode in many buffers.
Specifically, Show-Smartparens mode is enabled in all buffers where
...
Setting this variable directly does not take effect;
either customize it (see the info node `Easy Customization')
or call the function `yas-global-mode'.") (custom-autoload 'yas-global-mode "yasnippet" nil) (autoload 'yas-global-mode "yasnippet" "Toggle Yas minor mode in many buffers.
...
(fn &optional ARG)" t) (autoload 'snippet-mode "yasnippet" "A mode for editing yasnippets" t nil) (register-definition-prefixes "yasnippet" '("help-snippet-def" "snippet-mode-map" "yas")) (provide 'yasnippet-autoloads)) "journalctl-mode" ((journalctl-mode-autoloads journalctl-mode) (autoload 'journalctl "journalctl-mode" "Run journalctl and open transient menu." t) (register-definition-prefixes "journalctl-mode" '("journalctl")) (provide 'journalctl-mode-autoloads)) "general" ((general general-autoloads) (autoload 'general-define-key "general" "The primary key definition function provided by general.el.
...
(fn KEYMAPS &rest ARGS)" nil t) (autoload 'general-evil-define-key "general" "A wrapper for `general-define-key' that is similar to `evil-define-key'.
...
(fn STATES KEYMAPS &rest ARGS)" nil t) (autoload 'general-def "general" "General definer that takes a variable number of positional arguments in ARGS.
...
(fn &rest ARGS)" nil t) (autoload 'general-create-definer "general" "A helper macro to create wrappers for `general-def'.
...
(fn NAME &rest DEFAULTS &key WRAPPING &allow-other-keys)" nil t) (autoload 'general-defs "general" "A wrapper that splits into multiple `general-def's.
...
(fn &rest ARGS)" nil t) (autoload 'general-unbind "general" "A wrapper for `general-def' to unbind multiple keys simultaneously.
...
(fn &rest ARGS)" nil t) (autoload 'general-describe-keybindings "general" "Show all keys that have been bound with general in an org buffer.
...
(fn KEY &key STATE DOCSTRING LET SETUP TEARDOWN ACCEPT-DEFAULT NO-REMAP POSITION)" nil t) (autoload 'general-simulate-keys "general" "Deprecated. Please use `general-simulate-key' instead.
...
(fn KEYS &key STATE KEYMAP NAME DOCSTRING (LOOKUP t) WHICH-KEY (REMAP t))" nil t) (autoload 'general-key-dispatch "general" "Create and return a command that runs FALLBACK-COMMAND or a command in MAPS.
...
(fn FALLBACK-COMMAND &rest MAPS &key TIMEOUT INHERIT-KEYMAP NAME DOCSTRING WHICH-KEY (REMAP t) &allow-other-keys)" nil t) (autoload 'general-predicate-dispatch "general" "

(fn FALLBACK-DEF &rest DEFS &key DOCSTRING &allow-other-keys)" nil t) (autoload 'general-translate-key "general" "Translate keys in the keymap(s) corresponding to STATES and KEYMAPS.
...
(fn STATES KEYMAPS &rest ARGS)" nil t) (autoload 'general-auto-unbind-keys "general" "Advise `define-key' to automatically unbind keys when necessary.
...
(fn &optional SHORT-NAMES _)") (register-definition-prefixes "general" '("general-")) (provide 'general-autoloads)) "s" ((s s-autoloads) (register-definition-prefixes "s" '("s-")) (provide 's-autoloads)) "avy" ((avy-autoloads avy) (autoload 'avy-process "avy" "Select one of CANDIDATES using `avy-read'.
...
(fn &rest CMD)") (register-definition-prefixes "pfuture" '("pfuture-")) (provide 'pfuture-autoloads)) "lv" ((lv lv-autoloads) (register-definition-prefixes "lv" '("lv-")) (provide 'lv-autoloads)) "hydra" ((hydra-examples hydra-autoloads hydra-ox hydra) (autoload 'defhydra "hydra" "Create a Hydra - a family of functions with prefix NAME.
...
(fn PROMPT &optional INITIAL-INPUT)") (register-definition-prefixes "cfrs" '("cfrs-")) (provide 'cfrs-autoloads)) "treemacs" ((treemacs-bookmarks treemacs-tags treemacs-extensions treemacs-follow-mode treemacs-logging treemacs-header-line treemacs-fringe-indicator treemacs-interface treemacs-async treemacs-mode treemacs-persistence treemacs-tag-follow-mode treemacs-rendering treemacs-treelib treemacs-autoloads treemacs-peek-mode treemacs-compatibility treemacs-customization treemacs-mouse-interface treemacs-file-management treemacs treemacs-workspaces treemacs-filewatch-mode treemacs-scope treemacs-git-commit-diff-mode treemacs-themes treemacs-icons treemacs-dom treemacs-hydras treemacs-project-follow-mode treemacs-annotations treemacs-visuals treemacs-macros treemacs-core-utils treemacs-faces) (autoload 'treemacs-version "treemacs" "Return the `treemacs-version'." t) (autoload 'treemacs "treemacs" "Initialise or toggle treemacs.
...
\\{treemacs-mode-map}" t) (register-definition-prefixes "treemacs-mode" '("treemacs-")) (autoload 'treemacs-leftclick-action "treemacs-mouse-interface" "Move focus to the clicked line.
...
KEYMAP is selected interactively by mode in
`minor-mode-map-alist'." t) (register-definition-prefixes "which-key" '("evil-state" "which-key-")) (provide 'which-key-autoloads)) "ace-jump-mode" ((ace-jump-mode ace-jump-mode-autoloads) (autoload 'ace-jump-mode-pop-mark "ace-jump-mode" "Pop up a postion from `ace-jump-mode-mark-ring', and jump back to that position" t) (autoload 'ace-jump-char-mode "ace-jump-mode" "AceJump char mode
...
(fn &optional PREFIX)" t) (register-definition-prefixes "ace-jump-mode" '("ace-jump-" "aj-")) (provide 'ace-jump-mode-autoloads)) "fzf" ((fzf-autoloads fzf) (autoload 'fzf "fzf" "Starts a fzf session in the appropriate directory.
...
(fn &optional WITH-PREVIEW)" t) (register-definition-prefixes "fzf" '("fzf")) (provide 'fzf-autoloads)) "vertico" ((vertico-unobtrusive vertico-multiform vertico vertico-buffer vertico-indexed vertico-directory vertico-flat vertico-reverse vertico-repeat vertico-autoloads vertico-suspend vertico-quick vertico-mouse vertico-sort vertico-grid) (defvar vertico-mode nil "Non-nil if Vertico mode is enabled.
...
(fn &optional ARG)" t) (autoload 'marginalia-cycle "marginalia" "Cycle between annotators in `marginalia-annotators'." t) (function-put 'marginalia-cycle 'completion-predicate #'(lambda (&rest _) (> (minibuffer-depth) 1))) (register-definition-prefixes "marginalia" '("marginalia-")) (provide 'marginalia-autoloads)) "corfu" ((corfu-echo corfu-popupinfo corfu-indexed corfu corfu-info corfu-auto corfu-history corfu-quick corfu-autoloads) (autoload 'corfu-mode "corfu" "COmpletion in Region FUnction.
...
Setting this variable directly does not take effect;
either customize it (see the info node `Easy Customization')
or call the function `global-corfu-mode'.") (custom-autoload 'global-corfu-mode "corfu" nil) (autoload 'global-corfu-mode "corfu" "Toggle Corfu mode in many buffers.
...
(fn &optional ARG)" t) (register-definition-prefixes "corfu-popupinfo" '("corfu-popupinfo-")) (autoload 'corfu-quick-jump "corfu-quick" "Jump to candidate using quick keys." t) (autoload 'corfu-quick-insert "corfu-quick" "Insert candidate using quick keys." t) (autoload 'corfu-quick-complete "corfu-quick" "Complete candidate using quick keys." t) (register-definition-prefixes "corfu-quick" '("corfu-quick")) (provide 'corfu-autoloads)) "nerd-icons-corfu" ((nerd-icons-corfu nerd-icons-corfu-autoloads) (autoload 'nerd-icons-corfu-formatter "nerd-icons-corfu" "A margin formatter for Corfu, adding icons.

It receives METADATA, ignores it, and outputs a function that takes a candidate
and returns the icon.

(fn _)") (register-definition-prefixes "nerd-icons-corfu" '("nerd-icons-corfu-")) (provide 'nerd-icons-corfu-autoloads)) "popon" ((popon-autoloads popon) (autoload 'poponp "popon" "Return t if OBJECT is a popon.

(fn OBJECT)") (autoload 'popon-live-p "popon" "Return t if OBJECT is a popon and not killed.

(fn OBJECT)") (autoload 'popon-get "popon" "Get the PROP property of popon POPON.

(fn POPON PROP)") (autoload 'popon-put "popon" "Set the PROP property of popon POPON to VALUE.

(fn POPON PROP VALUE)") (autoload 'popon-properties "popon" "Return a copy the property list of popon POPON.

(fn POPON)") (autoload 'popon-position "popon" "Return the position of popon POPON as a cons (X, Y).

When popon POPON is killed, return nil.

(fn POPON)") (autoload 'popon-size "popon" "Return the size of popon POPON as a cons (WIDTH . HEIGHT).

When popon POPON is killed, return nil.

(fn POPON)") (autoload 'popon-window "popon" "Return the window popon POPON belongs to.

Return nil if popon POPON is killed.

(fn POPON)") (autoload 'popon-buffer "popon" "Return the buffer popon POPON belongs to.

Return nil if popon POPON is killed.

(fn POPON)") (autoload 'popon-text "popon" "Return the text popon POPON is displaying.

POPON may be a killed popon.  Return nil if POPON isn't a popon at
all.

(fn POPON)") (autoload 'popon-create "popon" "Create a popon showing TEXT at POS of WINDOW.
...
(fn TEXT POS &optional WINDOW BUFFER PRIORITY)") (autoload 'popon-kill "popon" "Kill popon POPON.

Do nothing if POPON isn't a live popon.  Return nil.

(fn POPON)") (autoload 'popon-redisplay "popon" "Redisplay popon overlays.") (autoload 'popon-update "popon" "Update popons if needed.") (autoload 'popon-x-y-at-posn "popon" "Return the (X, Y) coodinate at position POSN as a cons.
...
(fn POSN)") (autoload 'popon-x-y-at-pos "popon" "Return the (X, Y) coodinate of POINT in selected window as a cons.
...
(fn POINT)") (autoload 'popon-kill-all "popon" "Kill all popons." t) (register-definition-prefixes "popon" '("popon-")) (provide 'popon-autoloads)) "corfu-terminal" ((corfu-terminal corfu-terminal-autoloads) (defvar corfu-terminal-mode nil "Non-nil if Corfu-Terminal mode is enabled.
See the `corfu-terminal-mode' command
for a description of this minor mode.") (custom-autoload 'corfu-terminal-mode "corfu-terminal" nil) (autoload 'corfu-terminal-mode "corfu-terminal" "Corfu popup on terminal.
...
(fn &optional ARG)" t) (register-definition-prefixes "corfu-terminal" '("corfu-terminal-")) (provide 'corfu-terminal-autoloads)) "consult" ((consult-autoloads consult consult-kmacro consult-imenu consult-register consult-org consult-compile consult-info consult-flymake consult-xref) (autoload 'consult-completion-in-region "consult" "Use minibuffer completion as the UI for `completion-at-point'.
...
(fn FETCHER &optional ALIST)") (register-definition-prefixes "consult-xref" '("consult-xref--")) (provide 'consult-autoloads)) "spinner" ((spinner-autoloads spinner-pkg spinner) (autoload 'spinner-create "spinner" "Create a spinner of the given TYPE.
...
\\{markdown-mode-map}" t) (add-to-list 'auto-mode-alist '("\\.\\(?:md\\|markdown\\|mkd\\|mdown\\|mkdn\\|mdwn\\|mdx\\)\\'" . markdown-mode)) (autoload 'gfm-mode "markdown-mode" "Major mode for editing GitHub Flavored Markdown files.
...
\\{gfm-mode-map}" t) (autoload 'markdown-view-mode "markdown-mode" "Major mode for viewing Markdown content.

In addition to any hooks its parent mode `markdown-mode' might have
run, this mode runs the hook `markdown-view-mode-hook', as the final
or penultimate step during initialization.

\\{markdown-view-mode-map}" t) (autoload 'gfm-view-mode "markdown-mode" "Major mode for viewing GitHub Flavored Markdown content.
...
\\{gfm-view-mode-map}" t) (autoload 'markdown-live-preview-mode "markdown-mode" "Toggle native previewing on save for a specific markdown file.
...
Setting this variable directly does not take effect;
either customize it (see the info node `Easy Customization')
or call the function `global-eldoc-mode'." :set #'custom-set-minor-mode :initialize #'custom-initialize-after-file-load :type 'boolean) (custom-autoload 'global-eldoc-mode "eldoc" nil) (when (bound-and-true-p global-eldoc-mode) (add-to-list 'global-minor-modes 'global-eldoc-mode)) (autoload 'global-eldoc-mode "eldoc" "Toggle Eldoc mode in many buffers.
Specifically, Eldoc mode is enabled in all buffers where
...
See `eldoc-documentation-strategy' for more detail.") (register-definition-prefixes "eldoc" '("eldoc")) (provide 'eldoc-autoloads)) "lsp-mode" ((lsp-python-ty lsp-vetur lsp-tex lsp-wgsl lsp-headerline lsp-dockerfile lsp-ocaml lsp-toml-tombi lsp-v lsp-semantic-tokens lsp-rf lsp-json lsp-openscad lsp-semgrep lsp-typos lsp-ttcn3 lsp-sorbet lsp-move lsp-magik lsp-typeprof lsp-iedit lsp-nim lsp-verilog lsp-beancount lsp-vimscript lsp-astro lsp-credo lsp-elm lsp-markdown lsp-qml lsp-glsl lsp-ruff lsp-yaml lsp-zig lsp-camel lsp-racket lsp-modeline lsp-steep lsp-bash lsp-idris lsp-gdscript lsp-asm lsp-dired lsp-php lsp-jsonnet lsp-crystal lsp-mode lsp-prolog lsp-sqls lsp-nushell lsp-terraform lsp-emmet lsp-hy lsp-d lsp-earthly lsp-clojure lsp-gleam lsp-cypher lsp-cobol lsp-clangd lsp-ido lsp-toml lsp-inline-completion lsp-mdx lsp-kubernetes-helm lsp-meson lsp-sml lsp-ruby-syntax-tree lsp-xml lsp-purescript lsp-elixir lsp-erlang lsp-haxe lsp-css lsp-pylsp lsp-crates lsp-volar lsp-marksman lsp-fortran lsp-rpm-spec lsp-angular lsp-dot lsp-perl lsp-dhall lsp-nix lsp-completion lsp-cucumber lsp-autotools lsp-ts-query lsp-solidity lsp-pwsh lsp-icons lsp-c3 lsp-nextflow lsp-typst lsp-javascript lsp-vala lsp lsp-svelte lsp-remark lsp-jq lsp-protocol lsp-lua lsp-go lsp-yang lsp-postgres lsp-html lsp-pyls lsp-odin lsp-golangci-lint lsp-futhark lsp-typespec lsp-lisp lsp-ansible lsp-roc lsp-ron lsp-ruby-lsp lsp-r lsp-eslint lsp-groovy lsp-bufls lsp-fsharp lsp-solargraph lsp-graphql lsp-actionscript lsp-lens lsp-just lsp-rubocop lsp-mode-autoloads lsp-fennel lsp-kotlin lsp-wat lsp-perlnavigator lsp-rust lsp-mint lsp-fortitude lsp-vhdl lsp-mojo lsp-tilt lsp-copilot lsp-ada lsp-pls lsp-awk lsp-sql lsp-diagnostics lsp-csharp lsp-matlab lsp-trunk lsp-roslyn lsp-cmake lsp-hack lsp-nginx) (register-definition-prefixes "lsp-actionscript" '("lsp-actionscript-")) (put 'lsp-ada-project-file 'safe-local-variable 'stringp) (register-definition-prefixes "lsp-ada" '("lsp-ada-")) (register-definition-prefixes "lsp-angular" '("lsp-client")) (register-definition-prefixes "lsp-ansible" '("lsp-ansible-")) (register-definition-prefixes "lsp-asm" '("lsp-asm-")) (register-definition-prefixes "lsp-astro" '("lsp-astro--get-initialization-options")) (register-definition-prefixes "lsp-autotools" '("lsp-autotools-")) (register-definition-prefixes "lsp-awk" '("lsp-awk-executable")) (register-definition-prefixes "lsp-bash" '("lsp-bash-")) (register-definition-prefixes "lsp-beancount" '("lsp-beancount-")) (register-definition-prefixes "lsp-bufls" '("lsp-buf")) (register-definition-prefixes "lsp-c3" '("lsp-c")) (register-definition-prefixes "lsp-camel" '("lsp-camel-")) (autoload 'lsp-cpp-flycheck-clang-tidy-error-explainer "lsp-clangd" "Explain a clang-tidy ERROR by scraping documentation from llvm.org.
...
(fn GROUP-RESULTS)" t) (register-definition-prefixes "consult-lsp" '("consult-lsp-")) (provide 'consult-lsp-autoloads)) "embark" ((embark embark-autoloads embark-org) (defun embark--record-this-command nil "Record command which opened the minibuffer.
...
(fn &optional ARG)" t) (register-definition-prefixes "lsp-ui" '("lsp-ui-")) (register-definition-prefixes "lsp-ui-doc" '("lsp-ui-doc-")) (register-definition-prefixes "lsp-ui-flycheck" '("lsp-ui-flycheck-")) (register-definition-prefixes "lsp-ui-imenu" '("lsp-ui-imenu" "overlay-priority")) (register-definition-prefixes "lsp-ui-peek" '("lsp-")) (register-definition-prefixes "lsp-ui-sideline" '("lsp-ui-sideline")) (register-definition-prefixes "lsp-ui-util" '("lsp-ui-util-")) (provide 'lsp-ui-autoloads)) "lsp-treemacs" ((lsp-treemacs-generic lsp-treemacs lsp-treemacs-autoloads lsp-treemacs-themes) (autoload 'lsp-treemacs-symbols "lsp-treemacs" "Show symbols view." t) (autoload 'lsp-treemacs-java-deps-list "lsp-treemacs" "Display java dependencies." t) (autoload 'lsp-treemacs-java-deps-follow "lsp-treemacs" nil t) (defvar lsp-treemacs-sync-mode nil "Non-nil if Lsp-Treemacs-Sync mode is enabled.
...
(fn COMMAND &optional OUTPUT-BUFFER ERROR-BUFFER ENVVAR)" t) (register-definition-prefixes "with-editor" '("server-" "shell-command" "start-file-process" "with-editor")) (provide 'with-editor-autoloads)) "magit" ((magit-remote magit-bookmark magit-transient magit-push magit-log magit-ediff magit-branch git-commit magit .dir-locals magit-wip magit-notes magit-patch magit-repos magit-worktree magit-mode git-rebase magit-git magit-submodule magit-sparse-checkout magit-margin magit-gitignore magit-process magit-clone magit-stash magit-refs magit-files magit-autoloads magit-sequence magit-commit magit-core magit-fetch magit-merge magit-subtree magit-status magit-reset magit-autorevert magit-blame magit-pull magit-apply magit-dired magit-bisect magit-reflog magit-base magit-bundle magit-tag magit-diff magit-extras) (put 'git-commit-major-mode 'safe-local-variable (lambda (val) (memq val '(text-mode markdown-mode org-mode fundamental-mode log-edit-mode git-commit-elisp-text-mode)))) (register-definition-prefixes "git-commit" '("git-commit-" "global-git-commit-mode")) (autoload 'git-rebase-current-line "git-rebase" "Parse current line into a `git-rebase-action' instance.
...
Setting this variable directly does not take effect;
either customize it (see the info node `Easy Customization')
or call the function `magit-auto-revert-mode'." :set #'custom-set-minor-mode :initialize #'magit-auto-revert-mode--initialize :type 'boolean :group 'magit-auto-revert :group 'magit-essentials :package-version '(magit . "2.4.0") :link '(info-link "(magit)Automatic Reverting of File-Visiting Buffers")) (custom-autoload 'magit-auto-revert-mode "magit-autorevert" nil) (when (bound-and-true-p magit-auto-revert-mode) (add-to-list 'global-minor-modes 'magit-auto-revert-mode)) (autoload 'magit-auto-revert-mode "magit-autorevert" "Toggle Auto-Revert mode in many buffers.
...
(fn WORKTREE DIRECTORY)" t) (register-definition-prefixes "magit-worktree" '("magit-")) (provide 'magit-autoloads)) "pcache" ((pcache pcache-autoloads) (register-definition-prefixes "pcache" '("*pcache-repositor" "pcache-")) (provide 'pcache-autoloads)) "logito" ((logito logito-autoloads) (register-definition-prefixes "logito" '("logito-")) (provide 'logito-autoloads)) "marshal" ((marshal-autoloads marshal) (autoload 'marshal "marshal" "

(fn OBJ TYPE)") (autoload 'unmarshal "marshal" "

(fn OBJ BLOB TYPE)") (autoload 'marshal-defclass "marshal" "

(fn NAME SUPERCLASS SLOTS &rest OPTIONS-AND-DOC)" nil t) (register-definition-prefixes "marshal" '("marshal-" "unmarshal-internal")) (provide 'marshal-autoloads)) "gh" ((gh-auth gh gh-issue-comments gh-repos gh-profile gh-common gh-search gh-cache gh-issues gh-api gh-gist gh-comments gh-autoloads gh-pulls gh-pull-comments gh-orgs gh-users gh-url gh-oauth) (register-definition-prefixes "gh-api" '("gh-api")) (register-definition-prefixes "gh-auth" '("gh-")) (register-definition-prefixes "gh-cache" '("gh-cache")) (register-definition-prefixes "gh-comments" '("gh-comments-api-mixin")) (register-definition-prefixes "gh-common" '("gh-")) (register-definition-prefixes "gh-gist" '("gh-gist-api")) (register-definition-prefixes "gh-issues" '("gh-issues-")) (register-definition-prefixes "gh-oauth" '("gh-oauth-")) (register-definition-prefixes "gh-orgs" '("gh-orgs-api")) (register-definition-prefixes "gh-profile" '("gh-profile-")) (register-definition-prefixes "gh-pulls" '("gh-pulls-")) (register-definition-prefixes "gh-repos" '("gh-repos-api")) (register-definition-prefixes "gh-search" '("gh-search-")) (register-definition-prefixes "gh-url" '("gh-url-")) (register-definition-prefixes "gh-users" '("gh-users-api")) (provide 'gh-autoloads)) "magit-gh-pulls" ((magit-gh-pulls-autoloads magit-gh-pulls) (autoload 'magit-gh-pulls-mode "magit-gh-pulls" "Pull requests support for Magit
...
and call `auth-source-forget+'." t) (register-definition-prefixes "ghub" '("auth-source-netrc-parse" "ghub-")) (register-definition-prefixes "ghub-graphql" '("ghub-")) (register-definition-prefixes "ghub-legacy" '("ghub-fetch-repository")) (register-definition-prefixes "gsexp" '("gsexp-")) (provide 'ghub-autoloads)) "forge" ((forge-repo forge-gitlab forge forge-repos forge-post forge-tablist .dir-locals forge-pullreq forge-discussion forge-autoloads forge-bitbucket forge-gogs forge-gitea forge-revnote forge-core forge-topics forge-issue forge-client forge-semi forge-topic forge-db forge-forgejo forge-github forge-commands forge-notify) (defvar forge-add-default-bindings t "Whether to add Forge's bindings to various Magit keymaps.
...
(fn REPOSITORY)" t) (autoload 'forge-browse-blob "forge-commands" "Visit a blob using a browser.
...
(fn COMMIT FILE &optional LINE END FORCE-HASH)" t) (autoload 'forge-browse-this-topic "forge-commands" nil t) (autoload 'forge-browse-this-repository "forge-commands" "Visit the repository at point using a browser." t) (autoload 'forge-copy-url-at-point-as-kill "forge-commands" "Copy the url of thing at point or the thing visited in the current buffer." t) (autoload 'forge-browse "forge-commands" "Visit the thing at point using a browser." t) (autoload 'forge-visit-topic "forge-commands" "Read a TOPIC and visit it.
...
(fn TOPIC)" t) (autoload 'forge-visit-discussion "forge-commands" "Read a DISCUSSION and visit it.
By default only offer active topics for completion.  With a prefix
argument offer all topics.  While completion is in progress, \\<forge-read-topic-minibuffer-map>\\[forge-read-topic-lift-limit] lifts
the limitation to active topics.

(fn DISCUSSION)" t) (autoload 'forge-visit-issue "forge-commands" "Read an ISSUE and visit it.
...
(fn PULL-REQUEST)" t) (autoload 'forge-visit-topic-from-url "forge-commands" "Visit the topic specified by web URL.

(fn URL)" t) (autoload 'forge-visit-this-topic "forge-commands" "Visit the topic at point.
...
(fn PATH PULLREQ)" t) (autoload 'forge-push-to-unnamed-pullreq "forge-commands" nil t) (autoload 'forge-fork "forge-commands" "Fork the current repository to FORK and add it as a REMOTE.
...
(fn FORK REMOTE ALL)" t) (autoload 'forge-merge "forge-commands" nil t) (autoload 'forge-set-default-branch "forge-commands" "Change the default branch on the upstream remote and locally.
Also update the upstream branches of local branches accordingly." t) (autoload 'forge-rename-default-branch "forge-commands" "Rename the default branch on the upstream remote and locally.
Also update the upstream branches of local branches accordingly." t) (autoload 'forge-add-pullreq-refspec "forge-commands" nil t) (autoload 'forge-add-repository "forge-commands" nil t) (autoload 'forge-add-user-repositories "forge-commands" "Add all of USER's repositories from HOST to the database.
...
#s(hash-table test eq data (org-elpa #s(hash-table test equal data (version (16 "https://github.com/emacs-straight/org-mode.git") "use-package" nil "bind-key" nil "no-littering" nil "compat" nil "seq" nil "vterm" nil "elfeed" nil "rainbow-delimiters" nil "smartparens" nil "dash" nil "yasnippet" nil "cl-lib" nil "journalctl-mode" nil "general" nil "treemacs" nil "s" nil "ace-window" nil "avy" nil "pfuture" nil "hydra" nil "lv" nil "ht" nil "cfrs" nil "posframe" nil "nerd-icons" nil "treemacs-nerd-icons" nil "nerd-icons-completion" nil "doom-themes" nil "doom-modeline" nil "shrink-path" nil "f" nil "which-key" nil "ace-jump-mode" nil "fzf" nil "savehist" nil "vertico" nil "orderless" nil "marginalia" nil "corfu" nil "nerd-icons-corfu" nil "corfu-terminal" nil "popon" nil "consult" nil "consult-lsp" nil "lsp-mode" nil "spinner" nil "markdown-mode" nil "eldoc" nil "embark" nil "embark-consult" nil "lsp-ui" nil "lsp-treemacs" nil "dap-mode" nil "bui" nil "lsp-docker" nil "yaml" nil "magit" nil "cond-let" nil "llama" nil "magit-section" nil "transient" nil "with-editor" nil "magit-gh-pulls" nil "gh" nil "pcache" nil "logito" nil "marshal" nil "forge" nil "closql" nil "emacsql" nil "ghub" nil "treepy" nil "org" (org :type git :host github :protocol https :repo "emacs-straight/org-mode" :local-repo "org" :depth full :pre-build (straight-recipes-org-elpa--build) :build (:not autoloads) :files (:defaults "lisp/*.el" ("etc/styles/" "etc/styles/*"))) "org-roam" nil "org-roam-ui" nil "simple-httpd" nil "websocket" nil)) melpa #s(hash-table test equal data (version 3 "use-package" nil "bind-key" nil "no-littering" (no-littering :type git :host github :repo "emacscollective/no-littering") "compat" nil "seq" nil "vterm" (vterm :type git :files ("CMakeLists.txt" "elisp.c" "elisp.h" "emacs-module.h" "etc" "utf8.c" "utf8.h" "vterm.el" "vterm-module.c" "vterm-module.h" "vterm-pkg.el") :host github :repo "akermu/emacs-libvterm") "elfeed" (elfeed :type git :files (:defaults "README.md" "elfeed-pkg.el") :host github :repo "skeeto/elfeed") "rainbow-delimiters" (rainbow-delimiters :type git :host github :repo "Fanael/rainbow-delimiters") "smartparens" (smartparens :type git :host github :repo "Fuco1/smartparens") "dash" (dash :type git :files ("dash.el" "dash.texi" "dash-pkg.el") :host github :repo "magnars/dash.el") "yasnippet" (yasnippet :type git :files ("yasnippet.el" "snippets" "yasnippet-pkg.el") :host github :repo "joaotavora/yasnippet") "cl-lib" nil "journalctl-mode" (journalctl-mode :type git :host github :repo "SebastianMeisel/journalctl-mode") "general" (general :type git :host github :repo "noctuid/general.el") "treemacs" (treemacs :type git :files (:defaults "Changelog.org" "icons" "src/elisp/treemacs*.el" "src/scripts/treemacs*.py" (:exclude "src/extra/*") "treemacs-pkg.el") :host github :repo "Alexander-Miller/treemacs") "s" (s :type git :host github :repo "magnars/s.el") "ace-window" (ace-window :type git :host github :repo "abo-abo/ace-window") "avy" (avy :type git :host github :repo "abo-abo/avy") "pfuture" (pfuture :type git :host github :repo "Alexander-Miller/pfuture") "hydra" (hydra :type git :files (:defaults (:exclude "lv.el") "hydra-pkg.el") :host github :repo "abo-abo/hydra") "lv" (lv :type git :files ("lv.el" "lv-pkg.el") :host github :repo "abo-abo/hydra") "ht" (ht :type git :host github :repo "Wilfred/ht.el") "cfrs" (cfrs :type git :host github :repo "Alexander-Miller/cfrs") "posframe" (posframe :type git :host github :repo "tumashu/posframe") "nerd-icons" (nerd-icons :type git :files (:defaults "data" "nerd-icons-pkg.el") :host github :repo "rainstormstudio/nerd-icons.el") "treemacs-nerd-icons" (treemacs-nerd-icons :type git :host github :repo "rainstormstudio/treemacs-nerd-icons") "nerd-icons-completion" (nerd-icons-completion :type git :host github :repo "rainstormstudio/nerd-icons-completion") "doom-themes" (doom-themes :type git :files (:defaults "themes/*.el" "themes/*/*.el" "extensions/*.el" "doom-themes-pkg.el") :host github :repo "doomemacs/themes") "doom-modeline" (doom-modeline :type git :host github :repo "seagle0128/doom-modeline") "shrink-path" (shrink-path :type git :host gitlab :repo "bennya/shrink-path.el") "f" (f :type git :host github :repo "rejeep/f.el") "which-key" (which-key :type git :host github :repo "justbur/emacs-which-key") "ace-jump-mode" (ace-jump-mode :type git :host github :repo "winterTTr/ace-jump-mode") "fzf" (fzf :type git :host github :repo "bling/fzf.el") "savehist" nil "vertico" (vertico :type git :files (:defaults "extensions/vertico-*.el" "vertico-pkg.el") :host github :repo "minad/vertico") "orderless" (orderless :type git :host github :repo "oantolin/orderless") "marginalia" (marginalia :type git :host github :repo "minad/marginalia") "corfu" (corfu :type git :files (:defaults "extensions/corfu-*.el" "corfu-pkg.el") :host github :repo "minad/corfu") "nerd-icons-corfu" (nerd-icons-corfu :type git :host github :repo "LuigiPiucco/nerd-icons-corfu") "corfu-terminal" nil "popon" nil "consult" (consult :type git :host github :repo "minad/consult") "consult-lsp" (consult-lsp :type git :host github :repo "gagbo/consult-lsp") "lsp-mode" (lsp-mode :type git :files (:defaults "clients/*.*" "lsp-mode-pkg.el") :host github :repo "emacs-lsp/lsp-mode") "spinner" nil "markdown-mode" (markdown-mode :type git :host github :repo "jrblevin/markdown-mode") "eldoc" nil "embark" (embark :type git :files ("embark.el" "embark-org.el" "embark.texi" "embark-pkg.el") :host github :repo "oantolin/embark") "embark-consult" (embark-consult :type git :files ("embark-consult.el" "embark-consult-pkg.el") :host github :repo "oantolin/embark") "lsp-ui" (lsp-ui :type git :files (:defaults "lsp-ui-doc.html" "resources" "lsp-ui-pkg.el") :host github :repo "emacs-lsp/lsp-ui") "lsp-treemacs" (lsp-treemacs :type git :files (:defaults "icons" "lsp-treemacs-pkg.el") :host github :repo "emacs-lsp/lsp-treemacs") "dap-mode" (dap-mode :type git :files (:defaults "icons" "dap-mode-pkg.el") :host github :repo "emacs-lsp/dap-mode") "bui" (bui :type git :host github :repo "alezost/bui.el") "lsp-docker" (lsp-docker :type git :host github :repo "emacs-lsp/lsp-docker") "yaml" (yaml :type git :host github :repo "zkry/yaml.el") "magit" (magit :type git :files ("lisp/magit*.el" "lisp/git-*.el" "docs/magit.texi" "docs/AUTHORS.md" "LICENSE" ".dir-locals.el" ("git-hooks" "git-hooks/*") (:exclude "lisp/magit-section.el") "magit-pkg.el") :host github :repo "magit/magit") "cond-let" (cond-let :type git :host github :repo "tarsius/cond-let") "llama" (llama :type git :files ("llama.el" ".dir-locals.el" "llama-pkg.el") :host github :repo "tarsius/llama") "magit-section" (magit-section :type git :files ("lisp/magit-section.el" "docs/magit-section.texi" "magit-section-pkg.el" "magit-section-pkg.el") :host github :repo "magit/magit") "transient" (transient :type git :host github :repo "magit/transient") "with-editor" (with-editor :type git :host github :repo "magit/with-editor") "magit-gh-pulls" (magit-gh-pulls :type git :host github :repo "sigma/magit-gh-pulls") "gh" (gh :type git :host github :repo "sigma/gh.el") "pcache" (pcache :type git :host github :repo "sigma/pcache") "logito" (logito :type git :host github :repo "sigma/logito") "marshal" (marshal :type git :host github :repo "sigma/marshal.el") "forge" (forge :type git :files ("lisp/*.el" "docs/*.texi" ".dir-locals.el" "forge-pkg.el") :host github :repo "magit/forge") "closql" (closql :type git :host github :repo "magit/closql") "emacsql" (emacsql :type git :files (:defaults "README.md" "sqlite" "emacsql-pkg.el") :host github :repo "magit/emacsql") "ghub" (ghub :type git :files ("lisp/*.el" "docs/*.texi" ".dir-locals.el" "ghub-pkg.el") :host github :repo "magit/ghub") "treepy" (treepy :type git :host github :repo "volrath/treepy.el") "org-roam" (org-roam :type git :files (:defaults "extensions/*" "org-roam-pkg.el") :host github :repo "org-roam/org-roam") "org-roam-ui" (org-roam-ui :type git :files (:defaults "out" "org-roam-ui-pkg.el") :host github :repo "org-roam/org-roam-ui") "simple-httpd" (simple-httpd :type git :host github :repo "skeeto/emacs-web-server") "websocket" (websocket :type git :host github :repo "ahyatt/emacs-websocket"))) gnu-elpa-mirror #s(hash-table test equal data (version 3 "use-package" (use-package :type git :host github :repo "emacs-straight/use-package" :files ("*" (:exclude ".git"))) "bind-key" (bind-key :type git :host github :repo "emacs-straight/bind-key" :files ("*" (:exclude ".git"))) "compat" (compat :type git :host github :repo "emacs-straight/compat" :files ("*" (:exclude ".git"))) "seq" (seq :type git :host github :repo "emacs-straight/seq" :files ("*" (:exclude ".git"))) "cl-lib" nil "savehist" nil "corfu-terminal" nil "popon" nil "spinner" (spinner :type git :host github :repo "emacs-straight/spinner" :files ("*" (:exclude ".git"))) "eldoc" (eldoc :type git :host github :repo "emacs-straight/eldoc" :files ("*" (:exclude ".git"))))) nongnu-elpa #s(hash-table test equal data (version (5 "https://github.com/emacsmirror/nongnu_elpa.git") "cl-lib" nil "savehist" nil "corfu-terminal" (corfu-terminal :repo "https://codeberg.org/akib/emacs-corfu-terminal") "popon" (popon :repo "https://codeberg.org/akib/emacs-popon"))) el-get #s(hash-table test equal data (version 2 "cl-lib" nil "savehist" nil)) emacsmirror-mirror #s(hash-table test equal data (version 2 "cl-lib" nil "savehist" nil))))

("websocket" "simple-httpd" "org-roam-ui" "org-roam" "org" "treepy" "ghub" "emacsql" "closql" "forge" "marshal" "logito" "pcache" "gh" "magit-gh-pulls" "with-editor" "transient" "magit-section" "llama" "cond-let" "magit" "yaml" "lsp-docker" "bui" "dap-mode" "lsp-treemacs" "lsp-ui" "embark-consult" "embark" "eldoc" "markdown-mode" "spinner" "lsp-mode" "consult-lsp" "consult" "popon" "corfu-terminal" "nerd-icons-corfu" "corfu" "marginalia" "orderless" "vertico" "savehist" "fzf" "ace-jump-mode" "which-key" "f" "shrink-path" "doom-modeline" "doom-themes" "nerd-icons-completion" "treemacs-nerd-icons" "nerd-icons" "posframe" "cfrs" "ht" "lv" "hydra" "pfuture" "avy" "ace-window" "s" "treemacs" "general" "journalctl-mode" "cl-lib" "yasnippet" "dash" "smartparens" "rainbow-delimiters" "elfeed" "vterm" "seq" "compat" "no-littering" "bind-key" "use-package" "emacsmirror-mirror" "el-get" "nongnu-elpa" "gnu-elpa-mirror" "melpa" "org-elpa" "emacs" "straight")
